...
namespace NIMBOLE.Entities
{
    ...
    using System.Linq;
    public partial class NimboleStagingEntities : DbContext
    {
        public NimboleStagingEntities()
            : base("name=NimboleStagingEntities")
        {
        }
        ...
        public virtual DbSet<TblEditLogTrack> TblEditLogTracks { get; set; }
        public virtual DbSet<TblEmpCosting> TblEmpCostings { get; set; }
        ...
        public virtual DbSet<TblLatLog> TblLatLogs { get; set; }
        ...
        public virtual DbSet<TblMasterTask> TblMasterTasks { get; set; }
        ...
        //public virtual DbSet<TblMasterTask> TblMasterTask { get; set; }
        ...
        public virtual DbSet<VWTransInfoDocument> VWTransInfoDocuments { get; set; }
        //public virtual DbSet<VWTrnContactAccount> VWTrnContactAccounts { get; set; }
        ...
        public virtual ObjectResult<sp_SalesFunnel_Result> sp_SalesFunnel(string tenantId)
        {
            var tenantIdParameter = tenantId != null ?
                new ObjectParameter("TenantId", tenantId) :
                new ObjectParameter("TenantId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_SalesFunnel_Result>("sp_SalesFunnel", tenantIdParameter);
        }
        ...
        public virtual ObjectResult<sp_SubordinatesByRoleOrder_Result> sp_SubordinatesByRoleOrder(Nullable<int> employeeId, string tenentId)
        {
            var employeeIdParameter = employeeId.HasValue ?
                new ObjectParameter("EmployeeId", employeeId) :
                new ObjectParameter("EmployeeId", typeof(int));
    
            var tenentIdParameter = tenentId != null ?
                new ObjectParameter("TenentId", tenentId) :
                new ObjectParameter("TenentId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_SubordinatesByRoleOrder_Result>("sp_SubordinatesByRoleOrder", employeeIdParameter, tenentIdParameter);
        }
    
        public virtual int sp_TargetVsActual(Nullable<int> employeeId, string finYear, string tenantId)
        {
            var employeeIdParameter = employeeId.HasValue ?
                new ObjectParameter("EmployeeId", employeeId) :
                new ObjectParameter("EmployeeId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_TargetVsActual", employeeIdParameter, finYearParameter, tenantIdParameter);
        }
